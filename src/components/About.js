...
export default function About(props) {
    const darkModeStyle = {
        ...
        border: props.mode === 'dark' ? '1px solid #ced4da' : ""
    }
    return (
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item" style={darkModeStyle}>
                    <h2 className="accordion-header" id="headingOne">
                        <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style={darkModeStyle}>
                            Accordion Item #1
                        </button>
                    </h2>
